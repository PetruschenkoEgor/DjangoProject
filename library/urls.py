...
from .views import BooksListView, BookDetailView, BookCreateView, BookUpdateView, BookDeleteView, AuthorsListView, \
    AuthorDetailView, AuthorUpdateView, AuthorDeleteView, AuthorCreateView, VideoListView, VideoCreateView, \
    VideoDetailView, RecommendBookView, ReviewBookView
